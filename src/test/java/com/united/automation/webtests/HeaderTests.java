...
public class HeaderTests extends BrowserLaunch {
    ...
    public void getTestData() throws IOException {
        ...
        String ActualStores = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/header/div[2]/nav/ul/li[2]/a")).getText();
        String ActualFuels = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/header/div[2]/nav/ul/li[3]/a")).getText();
        String ActualCards = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/header/div[2]/nav/ul/li[4]/a")).getText();
        String ActualWholesale = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/header/div[2]/nav/ul/li[5]/a")).getText();
        String ActualPie = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/header/div[2]/nav/ul/li[6]/a")).getText();
        //String ActualRefinery = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/header/div[2]/nav/ul/li[7]/a")).getText();
        String ActualAbout = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/header/div[2]/nav/ul/li[7]/a")).getText();
